...
struct TestValidator {
    ...
    _db_path: mango_temppath::TempPath,
}

impl TestValidator {
    fn new() -> Self {
        let _db_path = mango_temppath::TempPath::new();
...
//   language e2e tests in: mango/language/e2e-testsuite/src/tests/verify_txn.rs ->
...
//   - mango/language/move-binary-format/src/unit_tests/deserializer_tests.rs
//   - mango/language/move-binary-format/tests/serializer_tests.rs
...
//   mango/language/e2e-testsuite/src/tests/genesis.rs
...
fn test_validate_non_genesis_write_set() {
    ...
    // A WriteSet txn is only valid when sent from the mango root account.
