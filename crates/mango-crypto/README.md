...
id: crypto
title: Crypto
custom_edit_url: https://github.com/mango/mango/edit/latest/crates/mango-crypto/README.md
---

The crypto component hosts all the implementations of cryptographic primitives we use in mango: hashing, signing, and key derivation/generation. The parts of the library using traits.rs contains the crypto API enforcing type safety, verifiable random functions, EdDSA & MultiEdDSA signatures.

## Overview

mango makes use of several cryptographic algorithms:
