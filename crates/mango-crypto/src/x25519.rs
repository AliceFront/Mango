...
//!
//! ```
//! use mango_crypto::{x25519, Uniform, test_utils::TEST_SEED};
...
//! use mango_crypto::traits::ValidCryptoMaterialStringExt;
//! # fn main() -> Result<(), mango_crypto::traits::CryptoMaterialError> {
...
use mango_crypto_derive::{DeserializeKey, SerializeKey, SilentDebug, SilentDisplay};
...
// This makes it easier to uniformalize build dalek-x25519 in mango-core.
//
