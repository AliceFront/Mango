...
//! Noise is a [protocol framework](https://noiseprotocol.org/) which we use in mango to
...
//!
//! ```
//! use mango_crypto::{noise, x25519, traits::*};
//! use rand::prelude::*;
//!
//! # fn main() -> Result<(), mango_crypto::noise::NoiseError> {
