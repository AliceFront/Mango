...
//! mango project based on [RFC 5869](https://tools.ietf.org/html/rfc5869).
//!
...
//! for generating keys in mango, especially when a True Random Generator is not available.
