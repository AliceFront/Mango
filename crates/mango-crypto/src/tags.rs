...
//! This module provides definitions of tag types to be used by MIRAI analyzing mango-crypto.
//! This module gets compiled only if the mango-crypto is compiled via MIRAI in a debug build.
...
/// This type should only be accessible inside mango-crypto.
