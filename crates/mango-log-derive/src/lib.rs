...
pub fn derive(input: TokenStream) -> TokenStream {
    ...
    let from_serde = quote! { ::mango_logger::Value::from_serde };
    let from_display = quote! { ::mango_logger::Value::from_display };
    let from_debug = quote! { ::mango_logger::Value::from_debug };
    let key_new = quote! { ::mango_logger::Key::new };
    ...
    let expanded = quote! {
        ...
        impl #impl_generics ::mango_logger::Schema for #name #ty_generics #where_clause {
            fn visit(&self, visitor: &mut dyn ::mango_logger::Visitor) {
                #(#visits)*
            }
        }
    };
