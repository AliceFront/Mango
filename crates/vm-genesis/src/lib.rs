// Copyright (c) The mango Core Contributors
...
use mango_types::account_config;
...
pub fn encode_genesis_change_set(
    ...
    let xdx_ty = TypeTag::Struct(Box::new(StructTag {
...
pub struct Validator {
    /// The mango account address of the validator
    ...
    /// The mango account address of the validator's operator (same as `address` if the validator is
    /// its own operator)
