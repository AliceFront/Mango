...
use mango_json_rpc_types::views::{
...
/// The `VerifyingClient` is a [mango JSON-RPC client] that verifies mango's
...
///
/// [mango JSON-RPC client]: https://github.com/mango/mango/blob/master/json-rpc/json-rpc-spec.md
#[derive(Clone, Debug)]
