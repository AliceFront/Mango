...
Faucet is a service for creating and funding accounts on mango Network by treasury compliance account.
...
* Base URL: `http://faucet.testnet.mango.com/`
* Path: `/mint`
* Method: POST
...
The respond HTTP body is hex encoded bytes of BCS encoded `Vec<mango_types::transaction::SignedTransaction>`.

Decode Example ([source](https://mango.github.io/client-sdk-python/mango/testnet.html#mango.testnet.Faucet)):
...
``` python
  ...
  for i in range(length):
    txns.push(de.deserialize_any(mango_types.SignedTransaction))
...
```bash
curl -X POST http://faucet.testnet.mango.com/mint\?amount\=1000000\&currency_code\=XUS\&auth_key\=459c77a38803bd53f3adee52703810e3a74fd7c46952c497e75afb0a7932586d\&return_txns\=true
