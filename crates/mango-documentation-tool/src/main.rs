...
//! # Tool to help maintaining mango specifications.
//!
//! '''bash
//! cargo run -p mango-documentation-tool -- --help
//! '''

use mango_documentation_tool as diem_doc;
...
#[structopt(
    name = "mango documentation tool",
    about = "Tool to help maintaining mango specifications"
)]
struct Options {
