...
#[structopt(
    name = "swiss-knife",
    about = "Tool for generating, serializing (BCS), hashing and signing mango transactions. Additionally, contains tools for testing. Please refer to README.md for examples."
)]
struct Opt {
