...
//! This crates provides an API for logging in mango.
...
//! see the [coding guidelines](https://developers.mango.com/docs/core/coding-guidelines#logging).
//!
//! The below examples do no type checking for structured log fields, and instead just serialize
//! whatever is given.
//! ```
//! use mango_logger::info;
//!
//! let world = "world!";
//!
...
//!
//! ```
//! use mango_logger::{info, sample, sample::{SampleRate, Sampling}};
...
pub use mango_log_derive::Schema;
