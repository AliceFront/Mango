...
id: executor
title: Executor
custom_edit_url: https://github.com/mango/mango/edit/main/executor/README.md
---


## Overview

The mango Blockchain is a replicated state machine. Each validator is a replica
