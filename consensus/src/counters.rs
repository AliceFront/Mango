...
pub static OP_COUNTERS: Lazy<mango_metrics::OpMetrics> =
    Lazy::new(|| mango_metrics::OpMetrics::new_and_registered("consensus"));
...
//         "Histogram of proposal size after BCS but before wrapping with GRPC and mango net."
//     )
//     .unwrap()
// });
