...
use mango_config::config::ConsensusProposerType::{FixedProposer, RotatingProposer, RoundProposer};
...
#[ignore] // TODO: https://github.com/mango/mango/issues/8767
fn drop_config_test() {
    let mut runtime = consensus_runtime();
    let mut playground = NetworkPlayground::new(runtime.handle().clone());
    let num_nodes = 4;
...
#[test]
#[ignore] // TODO: https://github.com/mango/mango/issues/6615
