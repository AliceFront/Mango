...
use mango_crypto::{ed25519::Ed25519Signature, HashValue};
...
impl RootMetadata {
    ...
    pub fn new_empty() -> Self {
        Self::new(0, *mango_crypto::hash::ACCUMULATOR_PLACEHOLDER_HASH, vec![])
    }
}
...
/// The proxy we use to persist data in mango db storage service via grpc.
