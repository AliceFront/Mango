...
JSON-RPC service provides APIs for client applications to query the mango blockchain.
...
Refer to the [specification](https://github.com/mango/mango/blob/main/json-rpc/json-rpc-spec.md).
