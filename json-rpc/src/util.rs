...
impl SdkLang {
    ...
    pub fn from_str(user_agent_part: &str) -> SdkLang {
        match str::trim(user_agent_part) {
            "mango-client-sdk-rust" => SdkLang::Rust,
            "mango-client-sdk-java" => SdkLang::Java,
            "mango-client-sdk-python" => SdkLang::Python,
            "mango-client-sdk-typescript" => SdkLang::Typescript,
            "mango-client-sdk-golang" => SdkLang::Go,
            "mango-client-sdk-csharp" => SdkLang::CSharp,
            "mango-client-sdk-cpp" => SdkLang::Cpp,
            _ => SdkLang::Unknown,
        }
    }
...
impl SdkInfo {
    pub fn from_user_agent(user_agent: &str) -> SdkInfo {
        // parse our sdk user agent strings, i.e `mango-client-sdk-python / 0.1.12`
