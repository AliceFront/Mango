...
pub static RPC_REQUESTS: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "mango_client_service_rpc_requests_count",
...
pub static RPC_REQUEST_LATENCY: Lazy<HistogramVec> = Lazy::new(|| {
    register_histogram_vec!(
        "mango_client_service_rpc_request_latency_seconds",
        "mango client service rpc request latency histogram",
        &["type"] // batch / single
    )
    .unwrap()
});
...
pub static REQUESTS: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "mango_client_service_requests_count",
...
pub static INVALID_REQUESTS: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "mango_client_service_invalid_requests_count",
...
pub static INTERNAL_ERRORS: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "mango_client_service_internal_error_count",
...
pub static METHOD_LATENCY: Lazy<HistogramVec> = Lazy::new(|| {
    register_histogram_vec!(
        "mango_client_service_method_latency_seconds",
        "mango client service method latency histogram",
        &[
            "type",   // batch / single
