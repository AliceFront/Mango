...
//! See the following mango JSON-RPC response type documents for more details:
//! * https://github.com/mango/mango/blob/main/json-rpc/docs/type_account.md#type-account
//! * https://github.com/mango/mango/blob/main/json-rpc/docs/type_event.md#event-data
//! * https://github.com/mango/mango/blob/main/json-rpc/docs/type_transaction.md#type-vmstatus
//! * https://github.com/mango/mango/blob/main/json-rpc/docs/type_transaction.md#type-transactiondata
...
// other types, plese see https://github.com/mango/mango/blob/main/language/mango-framework/script_documentation/script_documentation.md for all available script names.
