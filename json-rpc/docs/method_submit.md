...
|-------|----------|------------------------------------------------------------------------------------------------------|
| data  | string   | Signed transaction data - hex-encoded bytes of [BCS][1] serialized mango [SignedTransaction][3] type.|

Steps to create "data" parameters:

1. Create [RawTransaction][2]
2. Create signing message:
   1. [SHA3](https://en.wikipedia.org/wiki/SHA-3) hash bytes of string "mango::RawTransaction".
...
* There is no partial execution in mango, hence the transaction either has full effect or has no effect at all.
...
[2]: https://developers.mango.com/docs/rustdocs/mango_types/transaction/struct.RawTransaction.html "RawTransaction"
[3]: https://developers.mango.com/docs/rustdocs/mango_types/transaction/struct.SignedTransaction.html "SignedTransaction"
