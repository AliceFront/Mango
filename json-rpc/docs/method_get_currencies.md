...
Get information about various currencies supported by the mango blockchain
...
curl -X POST -H "Content-Type: application/json" --data '{"jsonrpc":"2.0","method":"get_currencies","params":[],"id":1}' https://testnet.mango.com/v1
