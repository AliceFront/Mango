...
# 2020-12-07 Add a `X-mango-Chain-Id`, `X-mango-Ledger-Version` and `X-mango-Ledger-TimestampUsec` to http response header
...
* `X-mango-Chain-Id`: chain id of server
* `X-mango-Ledger-Version`: the latest ledger version when the request hit server.
* `X-mango-Ledger-TimestampUsec`: the latest ledger version's timestamp in usec when the request hit server.
...
- [See PR #6536](https://github.com/mango/mango/pull/6536)


## 2020-10-05 Rename `upgradeevent` to `admintransaction` event
- Changed the name and structure for `upgradeevent`
- [See PR #6449](https://github.com/mango/mango/pull/6449)


## 2020-10-08 Decode transaction script as name, code, arguments and type_arguments

- Transaction [Script](docs/type_transaction.md#type-script) is fulfilled with known script name as type, code, arguments and type_arguments. Similar with on-chain transaction [Script](https://developers.mango.com/docs/rustdocs/mango_types/transaction/struct.Script.html) type.
...
- [See PR #6453](https://github.com/mango/mango/pull/6453)


## 2020-10-07 Add `diem_version` field to `get_metadata` response

- `diem_version` number of mango onchain version
...
- [See PR #5798](https://github.com/mango/mango/pull/5798)
...
Please refer to [JSON-RPC SPEC before 2020-08-05](https://github.com/mango/mango/blob/888e6cd688a8c9b5805978ab509acdc3c35025ab/json-rpc/json-rpc-spec.md) document for the API spec snapshot.
