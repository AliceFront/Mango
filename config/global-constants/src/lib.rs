...
//! constants within the Mango codebase. This is useful because many different components within
//! Mango often require access to global constant definitions (e.g., Mango Safety Rules,
...
pub const MANGO_ROOT_KEY: &str = "mango_root";
