...
use mango_config::config;
use mango_types::chain_id::{self, ChainId};
...
///
/// ```
/// use mango_management::config::ConfigPath;
/// use structopt::StructOpt;
///
...
/// // ...
/// // OPTIONS:
/// //         --config <config>    Path to a mango-management configuration file
/// //         --test <test>
///
/// // let none  = "cmd";
...
/// Config for mango management tools
...
pub struct ConfigPath {
    /// Path to a mango-management configuration file
    #[structopt(long)]
...
mod tests {
    use super::*;
    use mango_config::config::{SecureBackend, Token, VaultConfig};
    use mango_types::chain_id::NamedChain;
