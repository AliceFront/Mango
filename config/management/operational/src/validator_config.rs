...
use mango_crypto::{ed25519::Ed25519PublicKey, x25519};
use mango_management::{error::Error, secure_backend::ValidatorBackend, storage::to_x25519};
use mango_types::{
...
pub struct SetValidatorConfig {
    ...
    #[structopt(flatten)]
    validator_config: mango_management::validator_config::ValidatorConfig,
    #[structopt(
        long,
...
pub struct ValidatorConfig {
    ...
    account_address: AccountAddress,
    #[structopt(flatten)]
    config: mango_management::config::ConfigPath,
    /// JSON-RPC Endpoint (e.g. http://localhost:8080)
    #[structopt(long, required_unless = "config")]
    json_server: Option<String>,
    #[structopt(
...
impl DecryptedValidatorConfig {
    pub fn from_validator_config_resource(
        config_resource: &mango_types::validator_config::ValidatorConfigResource,
        account_address: AccountAddress,
    ...
    pub fn from_validator_config(
        config: &mango_types::validator_config::ValidatorConfig,
        account_address: AccountAddress,
        encryptor: &Encryptor<Storage>,
    ) -> Result<Self, Error> {
