# mango Operational Tool

The `mango-operational-tool` provides a tool for operators to perform maintenance functions
on the mango blockchain post-genesis.  The functionality of the tool is
