...
[MSL]: https://github.com/mango/mango/blob/main/language/move-prover/doc/user/move-model.md
[PROVER]: https://github.com/mango/mango/blob/main/language/move-prover/doc/user/prover-guide.md
[BOOGIE]: https://github.com/boogie-org/boogie
[Z3]: https://github.com/Z3Prover/z3
[ACCESS_CONTROL]: https://github.com/mango/dip/blob/main/dips/dip-2.md

The mango framework comes with an exhaustive formal specification of modules and transaction scripts.
The specifications are formally verified against the Move implementation, with the verification enabled in
continuous integration, and successful verification a land blocker for each PR merged into the mango project.
...
## How the mango Framework is Specified


The mango framework uses the [Move Specification Language][MSL] for specification of properties. The language
...
## How the mango Framework is Verified
...
Verification of the mango framework is fully embedded into the developer workflow. A Rust integration test
...
At this point, the mango framework is specified to the following extent:
