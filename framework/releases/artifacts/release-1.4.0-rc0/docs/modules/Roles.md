...
This module defines role-based access control for the mango framework.
...
The signer didn't have the required mango Root role
...
Publishes mango root role. Granted only in genesis.
...
<pre><code><b>public</b> <b>fun</b> <a href="Roles.md#0x1_Roles_grant_diem_root_role">grant_diem_root_role</a>(
    ...
    // Checks actual <a href="mango.md#0x1_Diem">mango</a> root because <a href="mango.md#0x1_Diem">mango</a> root role is not set
    ...
    // Grant the role <b>to</b> the mango root account
...
The <code>creating_account</code> must be mango root.
...
Return true if <code>addr</code> is allowed to receive and send <code><a href="mango.md#0x1_Diem">mango</a>&lt;T&gt;</code> for any T
...
Assert that the account is mango root.
