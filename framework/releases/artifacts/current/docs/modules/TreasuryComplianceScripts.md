...
Cancels and returns all coins held in the <code><a href="mango.md#0x1_Diem_Preburn">mango::Preburn</a>&lt;Token&gt;</code> resource under the <code>preburn_address</code> and
...
The transaction must be sent by an <code>account</code> with a <code><a href="mango.md#0x1_Diem_BurnCapability">mango::BurnCapability</a>&lt;Token&gt;</code>
resource published under it. The account at <code>preburn_address</code> must have a
<code><a href="mango.md#0x1_Diem_Preburn">mango::Preburn</a>&lt;Token&gt;</code> resource published under it, and its value must be nonzero. The transaction removes
the entire balance held in the <code><a href="mango.md#0x1_Diem_Preburn">mango::Preburn</a>&lt;Token&gt;</code> resource, and returns it back to the account's
...
* A <code><a href="mango.md#0x1_Diem_CancelBurnEvent">mango::CancelBurnEvent</a></code> on the event handle held in the <code><a href="mango.md#0x1_Diem_CurrencyInfo">mango::CurrencyInfo</a>&lt;Token&gt;</code>
...
| ----------------              | --------------                                   | -------------                                                                                                                       |
| <code><a href="../../../../../../move-stdlib/docs/Errors.md#0x1_Errors_REQUIRES_CAPABILITY">Errors::REQUIRES_CAPABILITY</a></code> | <code><a href="mango.md#0x1_Diem_EBURN_CAPABILITY">mango::EBURN_CAPABILITY</a></code>                         | The sending <code>account</code> does not have a <code><a href="mango.md#0x1_Diem_BurnCapability">mango::BurnCapability</a>&lt;Token&gt;</code> published under it.                                             |
| <code><a href="../../../../../../move-stdlib/docs/Errors.md#0x1_Errors_INVALID_STATE">Errors::INVALID_STATE</a></code>       | <code><a href="mango.md#0x1_Diem_EPREBURN_NOT_FOUND">mango::EPREBURN_NOT_FOUND</a></code>                       | The <code><a href="mango.md#0x1_Diem_PreburnQueue">mango::PreburnQueue</a>&lt;Token&gt;</code> resource under <code>preburn_address</code> does not contain a preburn request with a value matching <code>amount</code>. |
| <code><a href="../../../../../../move-stdlib/docs/Errors.md#0x1_Errors_NOT_PUBLISHED">Errors::NOT_PUBLISHED</a></code>       | <code><a href="mango.md#0x1_Diem_EPREBURN_QUEUE">mango::EPREBURN_QUEUE</a></code>                           | The account at <code>preburn_address</code> does not have a <code><a href="mango.md#0x1_Diem_PreburnQueue">mango::PreburnQueue</a>&lt;Token&gt;</code> resource published under it.                           |
| <code><a href="../../../../../../move-stdlib/docs/Errors.md#0x1_Errors_NOT_PUBLISHED">Errors::NOT_PUBLISHED</a></code>       | <code><a href="mango.md#0x1_Diem_ECURRENCY_INFO">mango::ECURRENCY_INFO</a></code>                           | The specified <code>Token</code> is not a registered currency on-chain.                                                                        |
...
<b>include</b> <a href="mango.md#0x1_Diem_CancelBurnWithCapEnsures">mango::CancelBurnWithCapEnsures</a>&lt;Token&gt;;
...
<b>let</b> total_preburn_value = <b>global</b>&lt;<a href="mango.md#0x1_Diem_CurrencyInfo">mango::CurrencyInfo</a>&lt;Token&gt;&gt;(
    @CurrencyInfo
).preburn_value;
<b>let</b> post post_total_preburn_value = <b>global</b>&lt;<a href="mango.md#0x1_Diem_CurrencyInfo">mango::CurrencyInfo</a>&lt;Token&gt;&gt;(
    @CurrencyInfo
).preburn_value;
...
<b>include</b> <a href="mango.md#0x1_Diem_CancelBurnWithCapEmits">mango::CancelBurnWithCapEmits</a>&lt;Token&gt;;
...
<pre><code><b>include</b> <a href="mango.md#0x1_Diem_AbortsIfNoBurnCapability">mango::AbortsIfNoBurnCapability</a>&lt;Token&gt;{account: account};
</code></pre>
...
stored in the <code><a href="mango.md#0x1_Diem_Preburn">mango::Preburn</a>&lt;Token&gt;</code> resource published under the
<code>preburn_address</code> account address.

This transaction will only succeed if the sending <code>account</code> has a
<code><a href="mango.md#0x1_Diem_BurnCapability">mango::BurnCapability</a>&lt;Token&gt;</code>, and a <code><a href="mango.md#0x1_Diem_Preburn">mango::Preburn</a>&lt;Token&gt;</code> resource
...
<code><a href="mango.md#0x1_Diem_CurrencyInfo">mango::CurrencyInfo</a>&lt;Token&gt;</code> resource published under <code>0xA550C18</code> will be
...
The successful execution of this transaction will emit a <code><a href="mango.md#0x1_Diem_BurnEvent">mango::BurnEvent</a></code> on the event handle
held in the <code><a href="mango.md#0x1_Diem_CurrencyInfo">mango::CurrencyInfo</a>&lt;Token&gt;</code> resource's <code>burn_events</code> published under
<code>0xA550C18</code>.
...
<pre><code><b>public</b>(<b>script</b>) <b>fun</b> <a href="TreasuryComplianceScripts.md#0x1_TreasuryComplianceScripts_burn_with_amount">burn_with_amount</a>&lt;Token&gt;(account: signer, sliding_nonce: u64, preburn_address: address, amount: u64) {
    ...
    <a href="mango.md#0x1_Diem_burn">mango::burn</a>&lt;Token&gt;(&account, preburn_address, amount)
}
</code></pre>
...
<b>include</b> <a href="mango.md#0x1_Diem_BurnAbortsIf">mango::BurnAbortsIf</a>&lt;Token&gt;;
<b>include</b> <a href="mango.md#0x1_Diem_BurnEnsures">mango::BurnEnsures</a>&lt;Token&gt;;
<b>aborts_with</b> [check]
    <a href="../../../../../../move-stdlib/docs/Errors.md#0x1_Errors_INVALID_ARGUMENT">Errors::INVALID_ARGUMENT</a>,
    <a href="../../../../../../move-stdlib/docs/Errors.md#0x1_Errors_REQUIRES_CAPABILITY">Errors::REQUIRES_CAPABILITY</a>,
    <a href="../../../../../../move-stdlib/docs/Errors.md#0x1_Errors_NOT_PUBLISHED">Errors::NOT_PUBLISHED</a>,
    <a href="../../../../../../move-stdlib/docs/Errors.md#0x1_Errors_INVALID_STATE">Errors::INVALID_STATE</a>,
    <a href="../../../../../../move-stdlib/docs/Errors.md#0x1_Errors_LIMIT_EXCEEDED">Errors::LIMIT_EXCEEDED</a>;
<b>include</b> <a href="mango.md#0x1_Diem_BurnWithResourceCapEmits">mango::BurnWithResourceCapEmits</a>&lt;Token&gt;{preburn: <a href="mango.md#0x1_Diem_spec_make_preburn">mango::spec_make_preburn</a>(amount)};
</code></pre>
...
<code><a href="DiemAccount.md#0x1_DiemAccount_Balance">DiemAccount::Balance</a>&lt;Token&gt;</code> to the <code><a href="mango.md#0x1_Diem_Preburn">mango::Preburn</a>&lt;Token&gt;</code> published under the same
...
* A <code><a href="mango.md#0x1_Diem_PreburnEvent">mango::PreburnEvent</a></code> with <code>Token</code>'s currency code on the
<code><a href="mango.md#0x1_Diem_CurrencyInfo">mango::CurrencyInfo</a>&lt;Token</code>'s <code>preburn_events</code> handle for <code>Token</code> and with
...
| Error Category           | Error Reason                                             | Description                                                                             |
| ----------------         | --------------                                           | -------------                                                                           |
| <code><a href="../../../../../../move-stdlib/docs/Errors.md#0x1_Errors_NOT_PUBLISHED">Errors::NOT_PUBLISHED</a></code>  | <code><a href="mango.md#0x1_Diem_ECURRENCY_INFO">mango::ECURRENCY_INFO</a></code>                                  | The <code>Token</code> is not a registered currency on-chain.                                      |
...
| <code><a href="../../../../../../move-stdlib/docs/Errors.md#0x1_Errors_NOT_PUBLISHED">Errors::NOT_PUBLISHED</a></code>  | <code><a href="mango.md#0x1_Diem_EPREBURN">mango::EPREBURN</a></code>                                        | <code>account</code> doesn't have a <code><a href="mango.md#0x1_Diem_Preburn">mango::Preburn</a>&lt;Token&gt;</code> resource published under it.           |
| <code><a href="../../../../../../move-stdlib/docs/Errors.md#0x1_Errors_INVALID_STATE">Errors::INVALID_STATE</a></code>  | <code><a href="mango.md#0x1_Diem_EPREBURN_OCCUPIED">mango::EPREBURN_OCCUPIED</a></code>                               | The <code>value</code> field in the <code><a href="mango.md#0x1_Diem_Preburn">mango::Preburn</a>&lt;Token&gt;</code> resource under the sender is non-zero. |
...
<pre><code><b>aborts_if</b> !(<b>exists</b>&lt;<a href="mango.md#0x1_Diem_Preburn">mango::Preburn</a>&lt;Token&gt;&gt;(account_addr) || <b>exists</b>&lt;<a href="mango.md#0x1_Diem_PreburnQueue">mango::PreburnQueue</a>&lt;Token&gt;&gt;(account_addr));
</code></pre>
...
The successful execution of this transaction will emit a <code><a href="mango.md#0x1_Diem_BurnEvent">mango::BurnEvent</a></code> on the event handle
held in the <code><a href="mango.md#0x1_Diem_CurrencyInfo">mango::CurrencyInfo</a>&lt;CoinType&gt;</code> resource's <code>burn_events</code> published under
<code>0xA550C18</code>.
...
| <code><a href="../../../../../../move-stdlib/docs/Errors.md#0x1_Errors_INVALID_ARGUMENT">Errors::INVALID_ARGUMENT</a></code> | <code><a href="mango.md#0x1_Diem_ECOIN">mango::ECOIN</a></code>                        | The collected fees in <code>CoinType</code> are zero.                  |
...
* A <code><a href="mango.md#0x1_Diem_MintEvent">mango::MintEvent</a></code> with the amount and currency code minted is emitted on the
<code>mint_event_handle</code> in the stored <code><a href="mango.md#0x1_Diem_CurrencyInfo">mango::CurrencyInfo</a>&lt;CoinType&gt;</code> resource stored under
...
| <code><a href="../../../../../../move-stdlib/docs/Errors.md#0x1_Errors_REQUIRES_CAPABILITY">Errors::REQUIRES_CAPABILITY</a></code> | <code><a href="mango.md#0x1_Diem_EMINT_CAPABILITY">mango::EMINT_CAPABILITY</a></code>                    | <code>tc_account</code> does not have a <code><a href="mango.md#0x1_Diem_MintCapability">mango::MintCapability</a>&lt;CoinType&gt;</code> resource published under it.                                  |
| <code><a href="../../../../../../move-stdlib/docs/Errors.md#0x1_Errors_INVALID_STATE">Errors::INVALID_STATE</a></code>       | <code><a href="mango.md#0x1_Diem_EMINTING_NOT_ALLOWED">mango::EMINTING_NOT_ALLOWED</a></code>                | Minting is not currently allowed for <code>CoinType</code> coins.                                                                       |
...
| <code><a href="../../../../../../move-stdlib/docs/Errors.md#0x1_Errors_INVALID_ARGUMENT">Errors::INVALID_ARGUMENT</a></code> | <code><a href="AccountFreezing.md#0x1_AccountFreezing_ECANNOT_FREEZE_DIEM_ROOT">AccountFreezing::ECANNOT_FREEZE_DIEM_ROOT</a></code> | <code>to_freeze_account</code> was the mango Root account (<code>0xA550C18</code>).                              |
...
<pre><code><b>public</b>(<b>script</b>) <b>fun</b> <a href="TreasuryComplianceScripts.md#0x1_TreasuryComplianceScripts_update_exchange_rate">update_exchange_rate</a>&lt;Currency&gt;(
    ...
    <a href="mango.md#0x1_Diem_update_xdx_exchange_rate">mango::update_xdx_exchange_rate</a>&lt;Currency&gt;(&tc_account, rate);
}
</code></pre>
...
<b>include</b> <a href="mango.md#0x1_Diem_UpdateXDXExchangeRateAbortsIf">mango::UpdateXDXExchangeRateAbortsIf</a>&lt;Currency&gt;;
<b>include</b> <a href="mango.md#0x1_Diem_UpdateXDXExchangeRateEnsures">mango::UpdateXDXExchangeRateEnsures</a>&lt;Currency&gt;{xdx_exchange_rate: rate};
<b>include</b> <a href="mango.md#0x1_Diem_UpdateXDXExchangeRateEmits">mango::UpdateXDXExchangeRateEmits</a>&lt;Currency&gt;{xdx_exchange_rate: rate};
<b>aborts_with</b> [check]
    <a href="../../../../../../move-stdlib/docs/Errors.md#0x1_Errors_INVALID_ARGUMENT">Errors::INVALID_ARGUMENT</a>,
    <a href="../../../../../../move-stdlib/docs/Errors.md#0x1_Errors_REQUIRES_ADDRESS">Errors::REQUIRES_ADDRESS</a>,
    <a href="../../../../../../move-stdlib/docs/Errors.md#0x1_Errors_LIMIT_EXCEEDED">Errors::LIMIT_EXCEEDED</a>,
...
This transaction sets the <code>can_mint</code> field of the <code><a href="mango.md#0x1_Diem_CurrencyInfo">mango::CurrencyInfo</a>&lt;Currency&gt;</code> resource
...
| ----------------           | --------------                        | -------------                                        |
| <code><a href="../../../../../../move-stdlib/docs/Errors.md#0x1_Errors_REQUIRES_ADDRESS">Errors::REQUIRES_ADDRESS</a></code> | <code><a href="CoreAddresses.md#0x1_CoreAddresses_ETREASURY_COMPLIANCE">CoreAddresses::ETREASURY_COMPLIANCE</a></code> | <code>tc_account</code> is not the Treasury Compliance account. |
| <code><a href="../../../../../../move-stdlib/docs/Errors.md#0x1_Errors_NOT_PUBLISHED">Errors::NOT_PUBLISHED</a></code>    | <code><a href="mango.md#0x1_Diem_ECURRENCY_INFO">mango::ECURRENCY_INFO</a></code>               | <code>Currency</code> is not a registered currency on-chain.    |
...
<pre><code><b>public</b>(<b>script</b>) <b>fun</b> <a href="TreasuryComplianceScripts.md#0x1_TreasuryComplianceScripts_update_minting_ability">update_minting_ability</a>&lt;Currency&gt;(
    ...
    <a href="mango.md#0x1_Diem_update_minting_ability">mango::update_minting_ability</a>&lt;Currency&gt;(&tc_account, allow_minting);
}
</code></pre>
