...
<dl>
<dt>
<code>balance: <a href="mango.md#0x1_Diem_Diem">mango::mango</a>&lt;CoinType&gt;</code>
</dt>
<dd>
...
<pre><code><b>public</b> <b>fun</b> <a href="TransactionFee.md#0x1_TransactionFee_add_txn_fee_currency">add_txn_fee_currency</a>&lt;CoinType: store&gt;(tc_account: &signer) {
    <a href="mango.md#0x1_Diem_assert_is_currency">mango::assert_is_currency</a>&lt;CoinType&gt;();
    <b>assert</b>(
    ...
    move_to(
        ...
        <a href="TransactionFee.md#0x1_TransactionFee">TransactionFee</a>&lt;CoinType&gt; {
            balance: <a href="mango.md#0x1_Diem_zero">mango::zero</a>(),
            preburn: <a href="mango.md#0x1_Diem_create_preburn">mango::create_preburn</a>(tc_account)
        }
    )
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="TransactionFee.md#0x1_TransactionFee_pay_fee">pay_fee</a>&lt;CoinType&gt;(coin: <a href="mango.md#0x1_Diem_Diem">mango::mango</a>&lt;CoinType&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="TransactionFee.md#0x1_TransactionFee_pay_fee">pay_fee</a>&lt;CoinType: store&gt;(coin: <a href="mango.md#0x1_Diem">mango</a>&lt;CoinType&gt;) <b>acquires</b> <a href="TransactionFee.md#0x1_TransactionFee">TransactionFee</a> {
    ...
    <a href="mango.md#0x1_Diem_deposit">mango::deposit</a>(&<b>mut</b> fees.balance, coin)
}
</code></pre>
...
<b>include</b> <a href="mango.md#0x1_Diem_DepositAbortsIf">mango::DepositAbortsIf</a>&lt;CoinType&gt;{coin: fees, check: coin};
...
<pre><code><b>public</b> <b>fun</b> <a href="TransactionFee.md#0x1_TransactionFee_burn_fees">burn_fees</a>&lt;CoinType: store&gt;(
    ...
    <b>if</b> (<a href="XDX.md#0x1_XDX_is_xdx">XDX::is_xdx</a>&lt;CoinType&gt;()) {
        ...
        <b>let</b> coin = <a href="mango.md#0x1_Diem_withdraw_all">mango::withdraw_all</a>(&<b>mut</b> fees.balance);
        <b>let</b> burn_cap = <a href="mango.md#0x1_Diem_remove_burn_capability">mango::remove_burn_capability</a>&lt;CoinType&gt;(tc_account);
        // burn
        <a href="mango.md#0x1_Diem_burn_now">mango::burn_now</a>(
            coin,
            &<b>mut</b> fees.preburn,
            tc_address,
            &burn_cap
        );
        <a href="mango.md#0x1_Diem_publish_burn_capability">mango::publish_burn_capability</a>(tc_account, burn_cap);
    }
}
</code></pre>
...
<pre><code><b>ensures</b> <a href="mango.md#0x1_Diem_spec_market_cap">mango::spec_market_cap</a>&lt;CoinType&gt;()
    == <b>old</b>(<a href="mango.md#0x1_Diem_spec_market_cap">mango::spec_market_cap</a>&lt;CoinType&gt;()) - <b>old</b>(<a href="TransactionFee.md#0x1_TransactionFee_spec_transaction_fee">spec_transaction_fee</a>&lt;CoinType&gt;().balance.value);
</code></pre>
...
<pre><code><b>schema</b> <a href="TransactionFee.md#0x1_TransactionFee_BurnFeesNotXDX">BurnFeesNotXDX</a>&lt;CoinType&gt; {
    <b>include</b> <a href="mango.md#0x1_Diem_AbortsIfNoBurnCapability">mango::AbortsIfNoBurnCapability</a>&lt;CoinType&gt;{account: tc_account};
    ...
    <b>include</b> <a href="mango.md#0x1_Diem_BurnNowAbortsIf">mango::BurnNowAbortsIf</a>&lt;CoinType&gt;{coin: fees.balance, preburn: fees.preburn};
}
</code></pre>
...
<pre><code><b>schema</b> <a href="TransactionFee.md#0x1_TransactionFee_BurnFeesNotXDX">BurnFeesNotXDX</a>&lt;CoinType&gt; {
    <b>ensures</b> <b>exists</b>&lt;<a href="mango.md#0x1_Diem_BurnCapability">mango::BurnCapability</a>&lt;CoinType&gt;&gt;(<a href="../../../../../../move-stdlib/docs/Signer.md#0x1_Signer_spec_address_of">Signer::spec_address_of</a>(tc_account));
}
</code></pre>
