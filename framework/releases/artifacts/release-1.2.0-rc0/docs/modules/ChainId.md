...
The chain id distinguishes between different chains (e.g., testnet and the main mango network).
...
Publish the chain ID <code>id</code> of this mango instance under the DiemRoot account
...
Return the chain ID of this mango instance
...
When mango is operating, the chain id is always available.
