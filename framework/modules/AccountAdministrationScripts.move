...
module DiemFramework::AccountAdministrationScripts {
    ...
    /// | ----------------            | --------------                           | -------------                                                              |
    /// | `Errors::NOT_PUBLISHED`     | `mango::ECURRENCY_INFO`                  | The `Currency` is not a registered currency on-chain.                      |
    ...
    /// [authentication key derived from `public_key`](https://developers.mango.com/docs/core/accounts/#addresses-authentication-keys-and-cryptographic-keys)
    ...
    /// | Name            | Type         | Description                                                                                       |
    /// | ------          | ------       | -------------                                                                                     |
    /// | `dr_account`    | `signer`     | The signer of the sending account of the write set transaction. May only be the mango Root signer. |
