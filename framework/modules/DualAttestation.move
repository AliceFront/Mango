...
module DiemFramework::DualAttestation {
    ...
    fun dual_attestation_required<Token>(
        ...
        let approx_xdx_microdiem_value = mango::approx_xdx_for_value<Token>(deposit_value);
    ...
    spec schema DualAttestationRequiredAbortsIf<Token> {
        deposit_value: num;
        include mango::ApproxXdmForValueAbortsIf<Token>{from_value: deposit_value};
    ...
    spec fun spec_dual_attestation_required<Token>(
        ...
        mango::spec_approx_xdx_for_value<Token>(deposit_value)
    ...
    public fun initialize(dr_account: &signer) {
        ...
        let initial_limit = (INITIAL_DUAL_ATTESTATION_LIMIT as u128) * (mango::scaling_factor<XDX>() as u128);
    ...
    spec initialize {
        ...
        let initial_limit = INITIAL_DUAL_ATTESTATION_LIMIT * mango::spec_scaling_factor<XDX>();
        aborts_if initial_limit > MAX_U64 with Errors::LIMIT_EXCEEDED;
        include mango::AbortsIfNoCurrency<XDX>; // for scaling_factor.
    }
