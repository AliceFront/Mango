...
module DiemFramework::DiemId {
    ...
    /// This resource holds an entity's domain names needed to send and receive payments using mango IDs.
    ...
    struct DiemIdDomainEvent has drop, store {
        ...
        removed: bool,
        /// mango ID Domain string of the account
        domain: DiemIdDomain,
    ...
    /// Before sending or receiving any payments using mango IDs, the Treasury Compliance account must send
