...
An <code>address</code> is a mango Account iff it has a published DiemAccount resource.
...
<dl>
<dt>
<code>coin: <a href="mango.md#0x1_Diem_Diem">mango::mango</a>&lt;Token&gt;</code>
</dt>
<dd>
...
The holder of WithdrawCapability for account_address can withdraw mango from
...
<dd>
 The amount of mango<Token> sent
</dd>
<dt>
...
<dd>
 The amount of mango<Token> received
</dd>
<dt>
<code>currency_code: vector&lt;u8&gt;</code>
</dt>
...
e.g., <code><a href="mango.md#0x1_Diem">mango</a>&lt;<a href="XDX.md#0x1_XDX">XDX</a>&gt;</code> to an account that exists, but does not have a <code><a href="DiemAccount.md#0x1_DiemAccount_Balance">Balance</a>&lt;<a href="XDX.md#0x1_XDX">XDX</a>&gt;</code> resource
...
<pre><code><b>fun</b> <a href="DiemAccount.md#0x1_DiemAccount_deposit">deposit</a>&lt;Token&gt;(payer: address, payee: address, to_deposit: <a href="mango.md#0x1_Diem_Diem">mango::mango</a>&lt;Token&gt;, metadata: vector&lt;u8&gt;, metadata_signature: vector&lt;u8&gt;, dual_attestation: bool)
</code></pre>
...
<pre><code><b>fun</b> <a href="DiemAccount.md#0x1_DiemAccount_deposit">deposit</a>&lt;Token&gt;(
    payer: address,
    payee: address,
    to_deposit: <a href="mango.md#0x1_Diem">mango</a>&lt;Token&gt;,
    metadata: vector&lt;u8&gt;,
    ...
    <b>let</b> deposit_value = <a href="mango.md#0x1_Diem_value">mango::value</a>(&to_deposit);
    ...
    <a href="mango.md#0x1_Diem_deposit">mango::deposit</a>(&<b>mut</b> borrow_global_mut&lt;<a href="DiemAccount.md#0x1_DiemAccount_Balance">Balance</a>&lt;Token&gt;&gt;(payee).coin, to_deposit);
    ...
    <a href="../../../../../../move-stdlib/docs/Event.md#0x1_Event_emit_event">Event::emit_event</a>&lt;<a href="DiemAccount.md#0x1_DiemAccount_ReceivedPaymentEvent">ReceivedPaymentEvent</a>&gt;(
        ...
        <a href="DiemAccount.md#0x1_DiemAccount_ReceivedPaymentEvent">ReceivedPaymentEvent</a> {
            ...
            currency_code: <a href="mango.md#0x1_Diem_currency_code">mango::currency_code</a>&lt;Token&gt;(),
            payer,
            metadata
        }
    );
...
<pre><code><b>schema</b> <a href="DiemAccount.md#0x1_DiemAccount_DepositAbortsIfRestricted">DepositAbortsIfRestricted</a>&lt;Token&gt; {
    ...
    <b>include</b> <a href="mango.md#0x1_Diem_AbortsIfNoCurrency">mango::AbortsIfNoCurrency</a>&lt;Token&gt;;
}
</code></pre>
...
<pre><code><b>schema</b> <a href="DiemAccount.md#0x1_DiemAccount_DepositEmits">DepositEmits</a>&lt;Token&gt; {
    ...
    <b>let</b> msg = <a href="DiemAccount.md#0x1_DiemAccount_ReceivedPaymentEvent">ReceivedPaymentEvent</a> {
        amount,
        currency_code: <a href="mango.md#0x1_Diem_spec_currency_code">mango::spec_currency_code</a>&lt;Token&gt;(),
        payer,
        metadata
    };
...
<b>modifies</b> <b>global</b>&lt;<a href="mango.md#0x1_Diem_CurrencyInfo">mango::CurrencyInfo</a>&lt;Token&gt;&gt;(@CurrencyInfo);
...
<pre><code><b>schema</b> <a href="DiemAccount.md#0x1_DiemAccount_TieredMintEnsures">TieredMintEnsures</a>&lt;Token&gt; {
    ...
    <b>let</b> currency_info = <b>global</b>&lt;<a href="mango.md#0x1_Diem_CurrencyInfo">mango::CurrencyInfo</a>&lt;Token&gt;&gt;(@CurrencyInfo);
    <b>let</b> post post_currency_info = <b>global</b>&lt;<a href="mango.md#0x1_Diem_CurrencyInfo">mango::CurrencyInfo</a>&lt;Token&gt;&gt;(@CurrencyInfo);
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="DiemAccount.md#0x1_DiemAccount_cancel_burn">cancel_burn</a>&lt;Token&gt;(
    ...
    <b>let</b> coin = <a href="mango.md#0x1_Diem_cancel_burn">mango::cancel_burn</a>&lt;Token&gt;(account, preburn_address, amount);
...
<pre><code><b>schema</b> <a href="DiemAccount.md#0x1_DiemAccount_CancelBurnAbortsIf">CancelBurnAbortsIf</a>&lt;Token&gt; {
    ...
    preburn_address: address;
    amount: u64;
    <b>include</b> <a href="mango.md#0x1_Diem_CancelBurnAbortsIf">mango::CancelBurnAbortsIf</a>&lt;Token&gt;;
...
Helper to withdraw <code>amount</code> from the given account balance and return the withdrawn mango<Token>


<pre><code><b>fun</b> <a href="DiemAccount.md#0x1_DiemAccount_withdraw_from_balance">withdraw_from_balance</a>&lt;Token&gt;(payer: address, payee: address, balance: &<b>mut</b> <a href="DiemAccount.md#0x1_DiemAccount_Balance">DiemAccount::Balance</a>&lt;Token&gt;, amount: u64): <a href="mango.md#0x1_Diem_Diem">mango::mango</a>&lt;Token&gt;
</code></pre>
...
<pre><code><b>fun</b> <a href="DiemAccount.md#0x1_DiemAccount_withdraw_from_balance">withdraw_from_balance</a>&lt;Token&gt;(
    ...
    amount: u64
): <a href="mango.md#0x1_Diem">mango</a>&lt;Token&gt; <b>acquires</b> <a href="DiemAccount.md#0x1_DiemAccount_AccountOperationsCapability">AccountOperationsCapability</a> {
    <a href="DiemTimestamp.md#0x1_DiemTimestamp_assert_operating">DiemTimestamp::assert_operating</a>();
    ...
    <b>assert</b>(<a href="mango.md#0x1_Diem_value">mango::value</a>(coin) &gt;= amount, <a href="../../../../../../move-stdlib/docs/Errors.md#0x1_Errors_limit_exceeded">Errors::limit_exceeded</a>(<a href="DiemAccount.md#0x1_DiemAccount_EINSUFFICIENT_BALANCE">EINSUFFICIENT_BALANCE</a>));
    <a href="mango.md#0x1_Diem_withdraw">mango::withdraw</a>(coin, amount)
}
</code></pre>
...
<pre><code><b>schema</b> <a href="DiemAccount.md#0x1_DiemAccount_WithdrawFromBalanceEnsures">WithdrawFromBalanceEnsures</a>&lt;Token&gt; {
    balance: <a href="DiemAccount.md#0x1_DiemAccount_Balance">Balance</a>&lt;Token&gt;;
    amount: u64;
    result: <a href="mango.md#0x1_Diem">mango</a>&lt;Token&gt;;
...
Withdraw <code>amount</code> <code><a href="mango.md#0x1_Diem">mango</a>&lt;Token&gt;</code>'s from the account balance under
<code>cap.account_address</code>


<pre><code><b>fun</b> <a href="DiemAccount.md#0x1_DiemAccount_withdraw_from">withdraw_from</a>&lt;Token&gt;(cap: &<a href="DiemAccount.md#0x1_DiemAccount_WithdrawCapability">DiemAccount::WithdrawCapability</a>, payee: address, amount: u64, metadata: vector&lt;u8&gt;): <a href="mango.md#0x1_Diem_Diem">mango::mango</a>&lt;Token&gt;
</code></pre>
...
<pre><code><b>fun</b> <a href="DiemAccount.md#0x1_DiemAccount_withdraw_from">withdraw_from</a>&lt;Token&gt;(
    ...
    amount: u64,
    metadata: vector&lt;u8&gt;,
): <a href="mango.md#0x1_Diem">mango</a>&lt;Token&gt; <b>acquires</b> <a href="DiemAccount.md#0x1_DiemAccount_Balance">Balance</a>, <a href="DiemAccount.md#0x1_DiemAccount_AccountOperationsCapability">AccountOperationsCapability</a>, <a href="DiemAccount.md#0x1_DiemAccount">DiemAccount</a> {
    <a href="DiemTimestamp.md#0x1_DiemTimestamp_assert_operating">DiemTimestamp::assert_operating</a>();
...
Withdraw <code>amount</code> <code><a href="mango.md#0x1_Diem">mango</a>&lt;Token&gt;</code>'s from <code>cap.address</code> and send them to the <code>Preburn</code>
...
<pre><code><b>public</b> <b>fun</b> <a href="DiemAccount.md#0x1_DiemAccount_preburn">preburn</a>&lt;Token&gt;(
    ...
    <a href="DiemTimestamp.md#0x1_DiemTimestamp_assert_operating">DiemTimestamp::assert_operating</a>();
    <a href="mango.md#0x1_Diem_preburn_to">mango::preburn_to</a>&lt;Token&gt;(dd, <a href="DiemAccount.md#0x1_DiemAccount_withdraw_from">withdraw_from</a>(cap, <a href="../../../../../../move-stdlib/docs/Signer.md#0x1_Signer_address_of">Signer::address_of</a>(dd), amount, x""))
}
</code></pre>
...
<pre><code><b>schema</b> <a href="DiemAccount.md#0x1_DiemAccount_PreburnAbortsIf">PreburnAbortsIf</a>&lt;Token&gt; {
    ...
    <b>include</b> <a href="mango.md#0x1_Diem_PreburnToAbortsIf">mango::PreburnToAbortsIf</a>&lt;Token&gt;{account: dd};
}
</code></pre>
...
<pre><code><b>schema</b> <a href="DiemAccount.md#0x1_DiemAccount_PreburnEnsures">PreburnEnsures</a>&lt;Token&gt; {
    <b>include</b> <a href="mango.md#0x1_Diem_PreburnToEnsures">mango::PreburnToEnsures</a>&lt;Token&gt;{amount, account: dd};
}
</code></pre>
...
<pre><code><b>schema</b> <a href="DiemAccount.md#0x1_DiemAccount_PreburnEmits">PreburnEmits</a>&lt;Token&gt; {
    ...
    amount: u64;
    <b>let</b> dd_addr = <a href="../../../../../../move-stdlib/docs/Signer.md#0x1_Signer_spec_address_of">Signer::spec_address_of</a>(dd);
    <b>include</b> <a href="mango.md#0x1_Diem_PreburnWithResourceEmits">mango::PreburnWithResourceEmits</a>&lt;Token&gt;{preburn_address: dd_addr};
...
Withdraw <code>amount</code> mango<Token> from the address embedded in <code><a href="DiemAccount.md#0x1_DiemAccount_WithdrawCapability">WithdrawCapability</a></code> and
...
<pre><code><b>schema</b> <a href="DiemAccount.md#0x1_DiemAccount_AddCurrencyForAccountAbortsIf">AddCurrencyForAccountAbortsIf</a>&lt;Token&gt; {
    ...
    <b>include</b> add_all_currencies && !<b>exists</b>&lt;<a href="DiemAccount.md#0x1_DiemAccount_Balance">Balance</a>&lt;<a href="XUS.md#0x1_XUS">XUS</a>&gt;&gt;(addr)
        ==&gt; <a href="mango.md#0x1_Diem_AbortsIfNoCurrency">mango::AbortsIfNoCurrency</a>&lt;<a href="XUS.md#0x1_XUS">XUS</a>&gt;;
    <b>include</b> add_all_currencies && !<b>exists</b>&lt;<a href="DiemAccount.md#0x1_DiemAccount_Balance">Balance</a>&lt;<a href="XDX.md#0x1_XDX">XDX</a>&gt;&gt;(addr)
        ==&gt; <a href="mango.md#0x1_Diem_AbortsIfNoCurrency">mango::AbortsIfNoCurrency</a>&lt;<a href="XDX.md#0x1_XDX">XDX</a>&gt;;
}
</code></pre>
...
Creates the mango root account (during genesis). Publishes the mango root role,
...
<pre><code><b>fun</b> <a href="DiemAccount.md#0x1_DiemAccount_balance_for">balance_for</a>&lt;Token&gt;(balance: &<a href="DiemAccount.md#0x1_DiemAccount_Balance">Balance</a>&lt;Token&gt;): u64 {
    <a href="mango.md#0x1_Diem_value">mango::value</a>&lt;Token&gt;(&balance.coin)
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="DiemAccount.md#0x1_DiemAccount_add_currency">add_currency</a>&lt;Token&gt;(account: &signer) {
    ...
    <a href="mango.md#0x1_Diem_assert_is_currency">mango::assert_is_currency</a>&lt;Token&gt;();
    ...
    move_to(account, <a href="DiemAccount.md#0x1_DiemAccount_Balance">Balance</a>&lt;Token&gt;{ coin: <a href="mango.md#0x1_Diem_zero">mango::zero</a>&lt;Token&gt;() })
}
</code></pre>
...
<pre><code><b>schema</b> <a href="DiemAccount.md#0x1_DiemAccount_AddCurrencyEnsures">AddCurrencyEnsures</a>&lt;Token&gt; {
    ...
    <b>ensures</b> <b>global</b>&lt;<a href="DiemAccount.md#0x1_DiemAccount_Balance">Balance</a>&lt;Token&gt;&gt;(addr)
        == <a href="DiemAccount.md#0x1_DiemAccount_Balance">Balance</a>&lt;Token&gt;{ coin: <a href="mango.md#0x1_Diem">mango</a>&lt;Token&gt; { value: 0 } };
}
</code></pre>
...
<pre><code><b>fun</b> <a href="DiemAccount.md#0x1_DiemAccount_epilogue_common">epilogue_common</a>&lt;Token&gt;(
    ...
    <b>if</b> (transaction_fee_amount &gt; 0) {
        ...
        <b>assert</b>(
            transaction_fee_amount &lt;= <a href="mango.md#0x1_Diem_value">mango::value</a>(coin),
        ...
        <a href="TransactionFee.md#0x1_TransactionFee_pay_fee">TransactionFee::pay_fee</a>(<a href="mango.md#0x1_Diem_withdraw">mango::withdraw</a>(coin, transaction_fee_amount))
    }
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="DiemAccount.md#0x1_DiemAccount_create_validator_account">create_validator_account</a>(
    ...
    <a href="Roles.md#0x1_Roles_assert_diem_root">Roles::assert_diem_root</a>(dr_account);
    <b>let</b> new_account = <a href="DiemAccount.md#0x1_DiemAccount_create_signer">create_signer</a>(new_account_address);
    // The dr_account account is verified <b>to</b> have the mango root role in `<a href="Roles.md#0x1_Roles_new_validator_role">Roles::new_validator_role</a>`
...
<pre><code><b>public</b> <b>fun</b> <a href="DiemAccount.md#0x1_DiemAccount_create_validator_operator_account">create_validator_operator_account</a>(
    ...
    <a href="Roles.md#0x1_Roles_assert_diem_root">Roles::assert_diem_root</a>(dr_account);
    <b>let</b> new_account = <a href="DiemAccount.md#0x1_DiemAccount_create_signer">create_signer</a>(new_account_address);
    // The dr_account is verified <b>to</b> have the mango root role in `<a href="Roles.md#0x1_Roles_new_validator_operator_role">Roles::new_validator_operator_role</a>`
...
There is a published AccountOperationsCapability iff there is an account and it's at mango root address
...
An account has a WriteSetManager iff if it is mango root
...
There is a VASPDomainManager at an address iff the address is a mango treasury compliance account
...
There is a VASPDomains at an address iff the address is a mango treasury compliance account
...
Account has SlidingNonce only if it's mango Root or Treasury Compliance
