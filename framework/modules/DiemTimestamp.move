...
module DiemFramework::DiemTimestamp {
    ...
    // - this is also needed for mango-framework unit test `DiemTimestampTests`. And once the above issue for df-cli is
    ...
    /// Helper function to determine if mango is operating. This is the same as `!is_genesis()` and is provided
