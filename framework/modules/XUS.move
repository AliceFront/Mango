...
module DiemFramework::XUS {
    ...
    public fun initialize(
        ...
        mango::register_SCS_currency<XUS>(
            dr_account,
            tc_account,
    ...
    spec module {
        ...
        invariant [suspendable] DiemTimestamp::is_operating() ==> mango::is_currency<XUS>();

        /// After genesis, `LimitsDefinition<XUS>` is published at mango root. It's published by
