...
module DiemFramework::Roles {
    ...
    public(friend) fun grant_diem_root_role(
        ...
        // Checks actual mango root because mango root role is not set
        // until next line of code.
        CoreAddresses::assert_diem_root(dr_account);
        // Grant the role to the mango root account
    ...
    /// The `creating_account` must be mango root.
    ...
    /// Return true if `addr` is allowed to receive and send `mango<T>` for any T
