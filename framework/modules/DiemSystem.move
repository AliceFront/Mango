...
module DiemFramework::DiemSystem {
    ...
    /// Only mango root can add or remove a validator from the validator set, so the
    ...
    /// Must be invoked by the mango root a single time in Genesis.
    ...
    ///////////////////////////////////////////////////////////////////////////
    // Methods operating the Validator Set config callable by the mango root account
    ///////////////////////////////////////////////////////////////////////////
    ...
    /// Removes a validator, aborts unless called by mango root account
