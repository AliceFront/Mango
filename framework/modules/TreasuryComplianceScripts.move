...
module DiemFramework::TreasuryComplianceScripts {
    ...
    /// Cancels and returns all coins held in the `mango::Preburn<Token>` resource under the `preburn_address` and
    /// return the funds to the `preburn_address` account's `DiemAccount::Balance<Token>`.
    /// The transaction must be sent by an `account` with a `mango::BurnCapability<Token>`
    /// resource published under it. The account at `preburn_address` must have a
    /// `mango::Preburn<Token>` resource published under it, and its value must be nonzero. The transaction removes
    /// the entire balance held in the `mango::Preburn<Token>` resource, and returns it back to the account's
    ...
    /// * A `mango::CancelBurnEvent` on the event handle held in the `mango::CurrencyInfo<Token>`
    ...
    /// | ----------------              | --------------                                   | -------------                                                                                                                       |
    /// | `Errors::REQUIRES_CAPABILITY` | `mango::EBURN_CAPABILITY`                         | The sending `account` does not have a `mango::BurnCapability<Token>` published under it.                                             |
    /// | `Errors::INVALID_STATE`       | `mango::EPREBURN_NOT_FOUND`                       | The `mango::PreburnQueue<Token>` resource under `preburn_address` does not contain a preburn request with a value matching `amount`. |
    /// | `Errors::NOT_PUBLISHED`       | `mango::EPREBURN_QUEUE`                           | The account at `preburn_address` does not have a `mango::PreburnQueue<Token>` resource published under it.                           |
    /// | `Errors::NOT_PUBLISHED`       | `mango::ECURRENCY_INFO`                           | The specified `Token` is not a registered currency on-chain.                                                                        |
    ...
    spec cancel_burn_with_amount {
        ...
        include mango::CancelBurnWithCapEnsures<Token>;
        include DiemAccount::DepositEnsures<Token>{payee: preburn_address};

        let total_preburn_value = global<mango::CurrencyInfo<Token>>(
            @CurrencyInfo
        ).preburn_value;
        let post post_total_preburn_value = global<mango::CurrencyInfo<Token>>(
            @CurrencyInfo
        ).preburn_value;
        ...
        include mango::CancelBurnWithCapEmits<Token>;
        ...
        include mango::AbortsIfNoBurnCapability<Token>{account: account};
    }
    ...
    /// stored in the `mango::Preburn<Token>` resource published under the
    /// `preburn_address` account address.
    ///
    /// This transaction will only succeed if the sending `account` has a
    /// `mango::BurnCapability<Token>`, and a `mango::Preburn<Token>` resource
    ...
    /// `mango::CurrencyInfo<Token>` resource published under `0xA550C18` will be
    ...
    ///
    /// # Events
    /// The successful execution of this transaction will emit a `mango::BurnEvent` on the event handle
    /// held in the `mango::CurrencyInfo<Token>` resource's `burn_events` published under
    /// `0xA550C18`.
    ///
    /// # Parameters
    /// | Name              | Type      | Description                                                                                                        |
    ...
    public(script) fun burn_with_amount<Token>(account: signer, sliding_nonce: u64, preburn_address: address, amount: u64) {
        ...
        mango::burn<Token>(&account, preburn_address, amount)
    }
    spec burn_with_amount {
        ...
        include mango::BurnAbortsIf<Token>;
        include mango::BurnEnsures<Token>;
        ...
        include mango::BurnWithResourceCapEmits<Token>{preburn: mango::spec_make_preburn(amount)};
    ...
    /// `DiemAccount::Balance<Token>` to the `mango::Preburn<Token>` published under the same
    ...
    /// * A `mango::PreburnEvent` with `Token`'s currency code on the
    /// `mango::CurrencyInfo<Token`'s `preburn_events` handle for `Token` and with
    ...
    /// | Error Category           | Error Reason                                             | Description                                                                             |
    /// | ----------------         | --------------                                           | -------------                                                                           |
    /// | `Errors::NOT_PUBLISHED`  | `mango::ECURRENCY_INFO`                                  | The `Token` is not a registered currency on-chain.                                      |
    ...
    /// | `Errors::NOT_PUBLISHED`  | `mango::EPREBURN`                                        | `account` doesn't have a `mango::Preburn<Token>` resource published under it.           |
    /// | `Errors::INVALID_STATE`  | `mango::EPREBURN_OCCUPIED`                               | The `value` field in the `mango::Preburn<Token>` resource under the sender is non-zero. |
    ...
    spec preburn {
        ...
        aborts_if !(exists<mango::Preburn<Token>>(account_addr) || exists<mango::PreburnQueue<Token>>(account_addr));
    }
    ...
    /// # Events
    /// The successful execution of this transaction will emit a `mango::BurnEvent` on the event handle
    /// held in the `mango::CurrencyInfo<CoinType>` resource's `burn_events` published under
    /// `0xA550C18`.
    ///
    /// # Parameters
    /// | Name         | Type     | Description                                                                                                                                         |
    ...
    /// | `Errors::INVALID_ARGUMENT` | `mango::ECOIN`                        | The collected fees in `CoinType` are zero.                  |
    ///
    /// # Related Scripts
    /// * `TreasuryComplianceScripts::burn_with_amount`
    /// * `TreasuryComplianceScripts::cancel_burn_with_amount`
    ...
    /// * A `mango::MintEvent` with the amount and currency code minted is emitted on the
    /// `mint_event_handle` in the stored `mango::CurrencyInfo<CoinType>` resource stored under
    /// `0xA550C18`; and
    ...
    /// | `Errors::REQUIRES_CAPABILITY` | `mango::EMINT_CAPABILITY`                    | `tc_account` does not have a `mango::MintCapability<CoinType>` resource published under it.                                  |
    /// | `Errors::INVALID_STATE`       | `mango::EMINTING_NOT_ALLOWED`                | Minting is not currently allowed for `CoinType` coins.                                                                       |
    ...
    /// not be either `0xA550C18` (the mango Root address), or `0xB1E55ED` (the
    ...
    /// | `Errors::INVALID_ARGUMENT` | `AccountFreezing::ECANNOT_FREEZE_DIEM_ROOT` | `to_freeze_account` was the mango Root account (`0xA550C18`).                              |
    ///
    /// # Related Scripts
    ...
    public(script) fun update_exchange_rate<Currency>(
        ...
        mango::update_xdx_exchange_rate<Currency>(&tc_account, rate);
    }
    spec update_exchange_rate {
        ...
        include mango::UpdateXDXExchangeRateAbortsIf<Currency>;
        include mango::UpdateXDXExchangeRateEnsures<Currency>{xdx_exchange_rate: rate};
        include mango::UpdateXDXExchangeRateEmits<Currency>{xdx_exchange_rate: rate};
    ...
    ///
    /// # Technical Description
    /// This transaction sets the `can_mint` field of the `mango::CurrencyInfo<Currency>` resource
    ...
    /// | `account`       | `signer` | Signer of the sending account. Must be the mango Root account.                                                                        |
    ...
    /// | ----------------           | --------------                        | -------------                                        |
    /// | `Errors::REQUIRES_ADDRESS` | `CoreAddresses::ETREASURY_COMPLIANCE` | `tc_account` is not the Treasury Compliance account. |
    /// | `Errors::NOT_PUBLISHED`    | `mango::ECURRENCY_INFO`               | `Currency` is not a registered currency on-chain.    |
    ///
    /// # Related Scripts
    /// * `TreasuryComplianceScripts::update_dual_attestation_limit`
    /// * `TreasuryComplianceScripts::update_exchange_rate`
    ...
    public(script) fun update_minting_ability<Currency>(
        ...
        mango::update_minting_ability<Currency>(&tc_account, allow_minting);
    }
