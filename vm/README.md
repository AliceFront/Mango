...
custom_edit_url: https://github.com/mango/mango/edit/main/language/move-binary-format/vm-runtime/README.md
---
...
Every transaction executes within the context of a [mango
account](../../mango-framework/modules/diem_account.mvir)---specifically the transaction
...
1. ***Transaction Prologue*** - in verification mode the runtime runs the
   ...
   prologue defined in the [mango account
   module](../../mango-framework/modules/diem_account.mvir). The prologue is responsible
...
3. ***Transaction Epilogue*** - in execution mode the epilogue defined in
   the [mango account module](../../mango-framework/modules/diem_account.mvir) is
...
* The runtime top level structs are in `runtime` and `mango vm` related
  code.
