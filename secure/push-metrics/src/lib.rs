...
impl MetricsPusher {
    fn push(push_metrics_endpoint: &str) {
        ...
        if let Err(e) = TextEncoder::new().encode(&mango_metrics_core::gather(), &mut buffer) {
