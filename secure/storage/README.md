...
custom_edit_url: https://github.com/mango/mango/edit/main/secure/storage/README.md
---
# Secure Storage

Secure storage provides a secure, persistent data store for sensitive data in the mango
blockchain. Examples of sensitive data here include information required for safety and
identity within mango, such as cryptographic keys and consensus safety rules, as well as
...
is the one primarily used in production environments by nodes in the mango blockchain.
