...
use mango_crypto::ed25519::{Ed25519PrivateKey, Ed25519PublicKey, Ed25519Signature};
...
pub trait CryptoStorage {
    ...
    /// mango to be run in test environments where a set of deterministic keys must be generated.
    ...
    fn sign<T: mango_crypto::hash::CryptoHash + serde::Serialize>(
        &self,
        name: &str,
        message: &T,
    ...
    // The FQDNs on the next line help macros, don't remove them
    fn sign_using_version<T: mango_crypto::hash::CryptoHash + serde::Serialize>(
        &self,
        name: &str,
        version: Ed25519PublicKey,
        message: &T,
