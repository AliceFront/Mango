...
/// This is the mango interface into secure storage. Any storage engine implementing this trait
...
impl CryptoStorage for Box<Storage> {
    ...
    fn sign<T: mango_crypto::hash::CryptoHash + Serialize>(
        &self,
        name: &str,
        message: &T,
    ...
    fn sign_using_version<T: mango_crypto::hash::CryptoHash + Serialize>(
        &self,
        name: &str,
        version: Ed25519PublicKey,
        message: &T,
