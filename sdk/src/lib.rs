...
//! let client = BlockingClient::new("http://testnet.mango.com/v1");
//! let faucet = FaucetClient::new("http://testnet.mango.com/mint".to_owned(), "http://testnet.mango.com/v1".to_owned());
