...
use mango_types::{ledger_info::LedgerInfoWithSignatures, transaction::Version};
...
pub enum TargetType {
    ...
    /// will be removed on the next breaking release: https://github.com/mango/mango/issues/8013
