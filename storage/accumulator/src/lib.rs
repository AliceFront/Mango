...
use mango_crypto::hash::{CryptoHash, CryptoHasher, HashValue, ACCUMULATOR_PLACEHOLDER_HASH};
use mango_types::proof::{
    ...
    H: CryptoHasher,
{
    ...
    ///
    /// See [`mango_types::proof::AccumulatorProof`] for proof format.
    pub fn get_proof(
        reader: &R,
    ...
    ///
    /// See [`mango_types::proof::AccumulatorConsistencyProof`] for proof format.
    ...
    ///
    /// See [`mango_types::proof::AccumulatorRangeProof`] for proof format.
