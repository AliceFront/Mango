...
//! This crate provides [`DiemDB`] which represents physical storage of the core mango data
//! structures.
//!
//! It relays read/write operations on the physical storage via [`schemadb`] to the underlying
//! Key-Value storage system, and implements mango data structures on top of it.
...
use mango_crypto::hash::{CryptoHash, HashValue, SPARSE_MERKLE_PLACEHOLDER_HASH};
...
/// access to the core mango data structures.
#[derive(Debug)]
pub struct DiemDB {
    db: Arc<DB>,
