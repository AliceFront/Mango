...
use mango_types::on_chain_config::{DiemVersion, DIEM_MAX_KNOWN_VERSION};
...
struct ReplayArgs {
    ...
    /// mango selector, if set, replay traces executed in that version instead of the latest version
    #[structopt(short = "d", long = "mango")]
