...
enum Command {
    ...
    /// Execute a writeset as if it is signed by the mango Root and print the result.
    #[structopt(name = "replay-writeset")]
    ReplayWriteSetAtVersion {
        /// Path to a serialized WriteSetPayload. Could be generated by the `mango-writeset-generator` tool.
    ...
    /// Get the bytecode for all mango Framework modules at `version`
