...
use mango_crypto_derive::{BCSCryptoHash, CryptoHasher};
...
pub struct RawTransaction {
    ...
    /// Chain ID of the mango network this transaction is intended for.
    chain_id: ChainId,
}
...
impl AccountTransactionsWithProof {
    ...
    // (Conflict-Resistant Sequence Numbers)[https://github.com/mango/dip/blob/main/dips/dip-168.md].
    //
...
/// `Transaction` will be the transaction type used internally in the mango node to represent the
