...
use mango_crypto_derive::{CryptoHasher, DeserializeKey, SerializeKey};
...
/// Each transaction submitted to the mango blockchain contains a `TransactionAuthenticator`. During
