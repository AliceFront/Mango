...
/// Defines the version of mango Validator software.
...
// NOTE: version number for release 1.2 mango
...
// NOTE: version number for release 1.3 of mango
// Items gated by this version number include:
//  - Multi-agent transactions
pub const DIEM_VERSION_3: DiemVersion = DiemVersion { major: 3 };

// NOTE: version number for release 1.4 of mango
// Items gated by this version number include:
