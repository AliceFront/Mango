...
/// tcp::Transport with mango-specific configuration applied.
pub const DIEM_TCP_TRANSPORT: tcp::TcpTransport = tcp::TcpTransport {
    // Use default options.
    ttl: None,
    // Use TCP_NODELAY for mango tcp connections.
    nodelay: Some(true),
};
...
// ideas in this PR thread: https://github.com/mango/mango/pull/3478#issuecomment-617385633
    ...
    TTransport::Listener: Send + 'static,
{
    ...
    fn parse_dial_addr(
        ...
        use mango_types::network_address::Protocol::*;
