...
//! We use Noise to secure connections between peers in mango.
...
//! use mango_config::{config::{Peer, PeerRole, RoleType}, network_id::{NetworkContext, NetworkId}};
//! use mango_crypto::{x25519, ed25519, Uniform, PrivateKey, test_utils::TEST_SEED};
...
//! [crypto]: ../mango_crypto/noise/index.html
