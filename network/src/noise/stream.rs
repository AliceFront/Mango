...
mod test {
    ...
    use mango_crypto::{test_utils::TEST_SEED, traits::Uniform as _, x25519};
    ...
    fn build_peers() -> (
        ...
        let client_peer_id = mango_types::account_address::from_identity_public_key(client_public);

        let server_private = x25519::PrivateKey::generate(&mut rng);
        let server_public = server_private.public_key();
        let server_peer_id = mango_types::account_address::from_identity_public_key(server_public);
