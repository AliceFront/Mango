...
use mango_crypto::{noise::NoiseSession, test_utils::TEST_SEED, x25519, Uniform as _};
...
pub static KEYPAIRS: Lazy<(
    ...
    let initiator_peer_id =
        mango_types::account_address::from_identity_public_key(initiator_public_key);
    ...
    let responder_peer_id =
        mango_types::account_address::from_identity_public_key(responder_public_key);
...
pub fn generate_corpus(gen: &mut mango_proptest_helpers::ValueGenerator) -> Vec<u8> {
