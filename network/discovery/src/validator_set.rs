...
use mango_types::on_chain_config::{OnChainConfigPayload, ValidatorSet};
...
mod tests {
    ...
    use mango_config::config::HANDSHAKE_VERSION;
    use mango_crypto::{
    ...
    fn metric_if_key_mismatch() {
        mango_logger::DiemLogger::init_for_testing();
        ...
        let peer_id = mango_types::account_address::from_identity_public_key(pubkey);
